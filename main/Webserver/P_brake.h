  ...
  <head>
    ...
    <script type = "text/javascript">
      function save(submit) {
          server = "/set/brake";
          server += "?disabledPos=" + val('disabledPos') + "&zeroPos=" + val('zeroPos') ;
          server += "&pressedPos=" + val('pressedPos') + "&curProp=" + val('curProp');
  ...
  <body onload = "load_brake();">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Актуатор тормоза</a></li>
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
        <h1>Управление актуатором тормоза</h1>
      </div>
      <h3>Параметры тормоза</h3>
      <br>
      <table class="table">
        <tbody>
          <tr>
          ...
          <tr>
            <td>Положение в полностью нажатом состоянии</td>
            <td>
