...
void setAlarm(int32_t state) {
    Signals::set_alarm(state);
    ESP_LOGI(TAG, "Alarm");
}
...
void start_udp_server() {
    ...
    dispatcher->AddMethod("set_alarm", &setAlarm);
...
void stop_udp_server() {
    serverStopped = true;
    ESP_LOGI(TAG, "UDP packets processing disabled");
}
